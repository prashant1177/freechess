  ...
  return (
    <aside className="w-1/4 border-r border-slate-700 p-6 bg-slate-800 hidden lg:flex flex-col justify-between">
          <div>
            ...
            <p className="text-lg font-bold text-blue-400">{turn == "W" ? "White to move" : "Black to move"}</p>

            <h2 className="text-xl font-semibold text-amber-400 mt-8 mb-2">Last Move</h2>
